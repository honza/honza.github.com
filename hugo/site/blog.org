...
* Posterous-style Blogging On App Engine   :@app-engine:@code:@python:
:PROPERTIES:
...
That's it!
* 7 ways Github has changed the open source world   :@git:@code:@open-source:
:PROPERTIES:
...
* JSLint syntax checker for vim   :@code:@vim:@open-source:
:PROPERTIES:
